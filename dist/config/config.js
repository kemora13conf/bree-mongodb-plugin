...
function validateAndNormalizeConfig(options) {
    if (!options.mongoose && !options.mongoClient && !options.uri && !options.connection && !options.db) {
        throw new Error('You must provide either a Mongoose instance, a MongoClient instance, a MongoDB connection URI, a Mongoose connection, or a MongoDB Db instance.');
    }
